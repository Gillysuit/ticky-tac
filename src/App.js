    ...
    const gameView = gameBoard => {
      ...
      gameBoard.forEach((row, rowIndex) => {
        ...
        row.forEach((symbols, rowPlace) => {
          newRow.push(
            <button value={`${rowIndex}, ${rowPlace}`} onClick={handleClick} className={['symbols', symbols ? symbols : ''].join(' ')}>
              {symbols}
            </button>
          );
        });
    ...
    return (
      <div>
        ...
        <div className="choices">
          <button className="symbols O" onClick={handleChoice} value="O">
            O
          </button>
          <button className="symbols X" onClick={handleChoice} value="X">
            X
          </button>
        </div>
      </div>
    ...
    if (winner !== null) {
      ...
      return (
        <div>
          ...
          <buttton className="reset" onClick={resetGame}>
            New Game
          </buttton>
        </div>
      );
